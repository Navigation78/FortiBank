...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    // Small delay to allow Supabase to process the URL hash token
    ...
    // Listen for auth events fired when Supabase processes the link token
        ...
        >
          {loading ? (
            <>
              ...
              {isInvite ? 'Activating account...' : 'Updating password...'}
            </>
          ) : (
