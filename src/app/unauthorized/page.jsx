  ...
  return (
    <div className="min-h-screen bg-th-bg flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-th-txt text-2xl font-bold mb-2">Access Denied</h1>
        <p className="text-th-txt2 text-sm mb-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            onClick={signOut}
            className="bg-th-hov hover:bg-th-act text-th-txt2 border border-th-brd font-medium rounded-lg py-2.5 text-sm transition-all duration-150"
          >
            Sign out
          </button>
        </div>
