...
const VARIANTS = {
  ...
  secondary: 'bg-white/[0.06] hover:bg-white/[0.10] active:bg-white/[0.04] disabled:opacity-40 disabled:cursor-not-allowed text-slate-200 border border-white/[0.08] hover:border-white/[0.14]',
  ...
  ghost:     'bg-transparent hover:bg-white/[0.06] active:bg-white/[0.04] disabled:opacity-40 disabled:cursor-not-allowed text-slate-300 hover:text-white',
}
